...
//neverused private Shop currentShop;
    ...
    private void initComponents() {
        ...
        setTitle(Constants.SERVER_NAME+" Shop Editor");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Shop shop = new Shop(Integer.parseInt(JOptionPane.showInputDialog("Enter NPC ID to use this shop")), false, new int[]{1}, new int[]{1}, false, 995);
        shops.add(shop);
    ...
    private void load() {
        try {
            ...
            for (int i = 0; i < shopsAmt; i++) {
                ...
                shops.add(new Shop(shopId, isGeneral, items, amounts, false, 995));
            }
