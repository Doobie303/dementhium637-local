...
public class ItemDefEditor extends javax.swing.JFrame {
    ...
    private static DefaultMutableTreeNode node = new DefaultMutableTreeNode("Items");
    ...
    private void initComponents() {
        ...
        meleeAbsorptionLabel = new javax.swing.JLabel();
		rangeAbsorptionField = new javax.swing.JTextField();
        rangeAbsorptionLabel = new javax.swing.JLabel();
		mageAbsorptionField = new javax.swing.JTextField();
        mageAbsorptionLabel = new javax.swing.JLabel();
        ...
        dumpAdsorption = new javax.swing.JMenuItem();
        ...
        setTitle(Constants.SERVER_NAME+" Item Editor"); 
		...
		meleeAbsorptionLabel.setFont(new java.awt.Font("Tahoma", 0, 12));
		meleeAbsorptionLabel.setText("Melee Absorption:");
		
		meleeAbsorptionField.setFont(new java.awt.Font("Tahoma", 0, 10));
		
		rangeAbsorptionLabel.setFont(new java.awt.Font("Tahoma", 0, 12));
		rangeAbsorptionLabel.setText("Range Absorption:");
		
		rangeAbsorptionField.setFont(new java.awt.Font("Tahoma", 0, 10));
		
		mageAbsorptionLabel.setFont(new java.awt.Font("Tahoma", 0, 12));
		mageAbsorptionLabel.setText("Mage Absorption:");
		
		mageAbsorptionField.setFont(new java.awt.Font("Tahoma", 0, 10));
                                ...
                                .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, extraDefsEditPanelLayout.createSequentialGroup()
                                                ...
                                                .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
														.addComponent(meleeAbsorptionLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
														.addComponent(rangeAbsorptionLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
														.addComponent(mageAbsorptionLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                ...
                                                .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
														...
														.addComponent(mageAbsorptionField, javax.swing.GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
														.addComponent(rangeAbsorptionField, javax.swing.GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
														.addComponent(meleeAbsorptionField, javax.swing.GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
														)))
                                .addContainerGap())
        );
                ...
                extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(extraDefsEditPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addGroup(extraDefsEditPanelLayout.createSequentialGroup()
                                                .addGap(2, 2, 2)
                                                .addComponent(meleeAbsorptionLabel))
                                        .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(meleeAbsorptionField, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(8, 8, 8)
                                .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addGroup(extraDefsEditPanelLayout.createSequentialGroup()
                                                .addGap(2, 2, 2)
                                                .addComponent(rangeAbsorptionLabel))
                                        .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(rangeAbsorptionField, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)))
								.addGap(8, 8, 8)
                                .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addGroup(extraDefsEditPanelLayout.createSequentialGroup()
                                                .addGap(2, 2, 2)
                                                .addComponent(mageAbsorptionLabel))
                                        .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(mageAbsorptionField, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)))
								.addGap(8, 8, 8)
                                .addGroup(extraDefsEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addGroup(extraDefsEditPanelLayout.createSequentialGroup()
                                                .addGap(2, 2, 2)
        ...
        dumpAdsorption.setText("Dump Absorption Bonuses");
        dumpAdsorption.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dumpAbsorptionBonuses(evt);
            }
        });
        fileMenu.add(dumpAdsorption);
    ...
    private void dumpDefsActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            while ((s = in.readLine()) != null) {
                ...
                if (s.contains("colspan=\"4\" sizeY=\"60\" align=\"center\">") || s.contains("<td colspan=\"4\" width=\"60\" align=\"center\">") || s.contains("</td><td colspan=\"4\" width=\"60\" align=\"center\">")) {//
                    System.out.println("Has Absorption");
					try {
                        absorption[absorbIndex] = Integer.valueOf(s.substring(s.indexOf("align=\"center\">") + "align=\"center\">".length()).replace("%", "").replace("+", ""));
                        absorbIndex++;
						System.out.println("Absorption: "+ Integer.valueOf(s.substring(s.indexOf("align=\"center\">") + "align=\"center\">".length()).replace("%", "").replace("+", "")));
                    } catch (Exception ex) {
						System.out.println("Doesn't have absorption");
    ...
    private void dumpAbsorptionBonuses(java.awt.event.ActionEvent evt) {
		/* if (true) {
			System.out.println("True");
            return;
        }*/
    	...
    	/*
    	 * For dumping all absorptions:
    	 */
    	/*int start = 8996;
    	int end = 11135;
    	for (int item = start; item < ItemDefinition.MAX_SIZE; item++) {
    		if (item == end) {
    			try {
    				repackFile();
    			} catch (Exception e) {
    				System.out.println("File was NOT packet correctly.");
    			}
    			return;
    		}
    		
            ItemDefinition def = ItemDefinition.forId(item);
            if (def == null && item != ItemDefinition.MAX_SIZE)
            	continue;
            if (def.isNoted() && item != ItemDefinition.MAX_SIZE)
            	continue;
            
            int targetSlot = Equipment.getItemType(item);
            if (def.getName().toLowerCase().contains("cape")) {
                targetSlot = Equipment.SLOT_CAPE;
            }
            if (def.getName().toLowerCase().contains("mask")) {
                targetSlot = Equipment.SLOT_HAT;
            }
            if (item == 542)
            	targetSlot = Equipment.SLOT_LEGS;
            else if (item == 544)
            	targetSlot = Equipment.SLOT_CHEST;
            if (targetSlot > 13 || targetSlot == 6 || targetSlot == 8 || targetSlot == 11) {
            	if (item != ItemDefinition.MAX_SIZE)
            		continue;
            }
	        ...
	        private void dumpPrice(int itemID) {
    ...
    private static javax.swing.JButton addExtraDefsButton;
    ...
    private static javax.swing.JTable bonusTable;
    private javax.swing.JPanel contentPanel;
    private javax.swing.JLabel defForLabel;
    private javax.swing.JButton deleteButton;
    private javax.swing.JMenuItem dumpDefs;
    private javax.swing.JMenuItem dumpAdsorption;
    private static javax.swing.JTextField equipIdField;
    private javax.swing.JLabel equipIdLabel;
    private static javax.swing.JTextField examineField;
    private javax.swing.JLabel examineLabel;
    private javax.swing.JLabel exchangeLabel;
    private static javax.swing.JTextField exchangePriceField;
    private javax.swing.JPanel extraDefsEditPanel;
    private static javax.swing.JPanel extraDefsPanel;
    ...
    private static javax.swing.JTextField highAlchField;
    private javax.swing.JLabel highAlchLabel;
    private static javax.swing.JLabel idLabel;
    private javax.swing.JPanel itemIdsPanel;
    private static javax.swing.JLabel itemImage;
    private javax.swing.JPanel itemImagePanel;
    private static javax.swing.JTree itemTree;
    private static javax.swing.JTextField lowAlchField;
    ...
    private static javax.swing.JTextField renderIdField;
    ...
    private static javax.swing.JPanel skillReqPanel;
    private javax.swing.JScrollPane skillReqScroll;
    private static javax.swing.JTable skillReqTable;
    private static javax.swing.JTextField slotField;
	...
	private static javax.swing.JTextField meleeAbsorptionField;
    private javax.swing.JLabel meleeAbsorptionLabel;
	private static javax.swing.JTextField rangeAbsorptionField;
    private javax.swing.JLabel rangeAbsorptionLabel;
	private static javax.swing.JTextField mageAbsorptionField;
    private javax.swing.JLabel mageAbsorptionLabel;
    // End of variables declaration//GEN-END:variables

    private static void loadItem(int parsedInt) throws IOException {
        ...
        if (!id.isNoted()) {
			...
			meleeAbsorptionField.setText(Integer.toString(id.getAbsorptionBonus()[0]));
			rangeAbsorptionField.setText(Integer.toString(id.getAbsorptionBonus()[2]));
			mageAbsorptionField.setText(Integer.toString(id.getAbsorptionBonus()[1]));
    ...
    public static void saveItem(int id, boolean repack) {
		int[] absorb = {(Integer.parseInt(meleeAbsorptionField.getText())),(Integer.parseInt(mageAbsorptionField.getText())),(Integer.parseInt(rangeAbsorptionField.getText()))};
        ...
        if (!ItemDefinition.getDefinitions()[id].isNoted()) {
			...
			ItemDefinition.getDefinitions()[id].setAbsorptionBonus(absorb);
			/* for (int i = 0; i < 3; i++) {
                //ItemDefinition.getDefinitions()[id].setBonusAtIndex(i, (Integer) bonusTable.getValueAt(0, i));
				ItemDefinition.getDefinitions()[id].setAbsorptionBonus(int[] absorptionBonus);
            }
			*/
    ...
    private static void repackFile() throws IOException {//It doesnt now, but ill make a backup anyway.
