...
public class StrongholdObjectListener extends EventListener {
    ...
    private boolean lootChest(final Player player, final int objectId, GameObject object, Location location) {
        ...
        if (objectId == 16118) {
            player.getSkills().heal(player.getSkills().getMaximumLifePoints());
    ...
    private Object[] getReward(int objectId) {
        ...
        if (objectId == 16135) {
            return new Object[]{0, "You open the gift of peace...", "..and find "+nf1.format(10000)+" coins.", new Item(995, 10000)};
        } else if (objectId == 16077) {
            return new Object[]{1, "You search the grain of plenty...", "..and find "+nf1.format(25000)+" coins.", new Item(995, 25000)};
        } else if (objectId == 16118) {
            return new Object[]{2, "You open the box of health...", "..it restored your life and prayer points and you find "+nf1.format(50000)+" coins.", new Item(995, 50000)};
    ...
    private boolean climbLadder(final Player player, final int objectId, Location location) {
        ...
        if (objectId == 16154) { //Barbarian village entrance.
            ...
            if (!player.getSettings().getStrongholdChest()[0]) {
                player.sendMessage("Make sure to loot the chest on this floor before you go down.");
                return true;
            }
