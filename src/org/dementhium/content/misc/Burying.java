...
public class Burying extends EventListener {
    ...
    public static enum Bone {
        ...
        DAG_BONE(6729, 40),
        FROST_BONE(18830, 73),
        FROST_BONE_2(18832, 73),
        SKELE_ARM(15217, 15),
        SKELE_ARM_1(15218, 15),
        SKELE_TAIL(15219, 15),
        ANCIENT_BONES(15410, 5);
    	 ...
    	 * The mapping.
    	 */
        public static HashMap<Integer, Bone> bones = new HashMap<Integer, Bone>();
    ...
    public boolean interfaceOption(final Player player, int interfaceId, int buttonId, final int slot, int itemId, int opcode) {
        ...
        final Bone bone = Bone.bones.get(itemId);
        if (bone != null) {
