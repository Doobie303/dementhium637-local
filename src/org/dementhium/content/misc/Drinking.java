...
public class Drinking extends EventListener {
    ...
    public static enum Drink {
        ...
        RANGE_POTION(new int[]{173, 171, 169, 2444}, new int[]{Skills.RANGED}, PotionType.NORMAL_POTION),

        MAGIC_POTION(new int[]{3046, 3044, 3042, 3040}, new int[]{Skills.MAGIC}, PotionType.PLUS_5),

        RESTORE_POTION(new int[]{131, 129, 127, 2430}, new int[]{Skills.DEFENCE, Skills.ATTACK, Skills.STRENGTH, Skills.MAGIC, Skills.RANGED}, PotionType.RESTORE),

        SUPER_RESTORE_POTION(new int[]{3030, 3028, 3026, 3024}, new int[]{Skills.ATTACK, Skills.STRENGTH, Skills.DEFENCE, Skills.MAGIC, Skills.RANGED, Skills.PRAYER, Skills.AGILITY, Skills.COOKING, Skills.CRAFTING, Skills.FARMING, Skills.FIREMAKING, Skills.FISHING, Skills.FLETCHING, Skills.HERBLORE, Skills.MINING, Skills.RUNECRAFTING, Skills.SLAYER, Skills.SMITHING, Skills.THIEVING, Skills.WOODCUTTING, Skills.SUMMONING}, PotionType.SUPER_RESTORE),

        SANFEW_SERUM(new int[]{10931, 10929, 10927, 10925}, new int[]{Skills.ATTACK, Skills.STRENGTH, Skills.DEFENCE, Skills.MAGIC, Skills.RANGED, Skills.PRAYER, Skills.AGILITY, Skills.COOKING, Skills.CRAFTING, Skills.FARMING, Skills.FIREMAKING, Skills.FISHING, Skills.FLETCHING, Skills.HERBLORE, Skills.MINING, Skills.RUNECRAFTING, Skills.SLAYER, Skills.SMITHING, Skills.THIEVING, Skills.WOODCUTTING, Skills.SUMMONING}, PotionType.SANFEW_SERUM),
        ...
        SARADOMIN_BREW(new int[]{6691, 6689, 6687, 6685}, new int[]{Skills.ATTACK, Skills.DEFENCE, Skills.STRENGTH, Skills.MAGIC, Skills.RANGED, Skills.CONSTITUTION}, PotionType.SARADOMIN_BREW),

        ZAMORAK_BREW(new int[]{193, 191, 189, 2450}, new int[]{Skills.ATTACK, Skills.STRENGTH, Skills.DEFENCE, Skills.CONSTITUTION, Skills.PRAYER}, PotionType.ZAMORAK_BREW),
        ...
        JUG(new int[]{1935, 1993}, new int[]{Skills.ATTACK, Skills.CONSTITUTION}, PotionType.WINE),

        OVERLOAD(new int[]{15335, 15334, 15333, 15332}, new int[]{Skills.ATTACK, Skills.STRENGTH, Skills.DEFENCE, Skills.RANGED, Skills.MAGIC}, PotionType.OVERLOAD),
        ...
        EXTREME_RANGING(new int[]{15327, 15326, 15325, 15324}, new int[]{Skills.RANGED}, PotionType.EXTREME),
        ...
        if (drink != null) {
            ...
            switch (drink.getPotionType()) {
                ...
                case SARADOMIN_BREW:
                    ...
                    for (int i = 0; i < drink.getSkills().length; i++) {
                        ...
                        if (skill == Skills.CONSTITUTION) {
                            int hitpointsModification = (int) (player.getSkills().getMaximumLifePoints() * 0.15);
                            player.getSkills().heal(hitpointsModification, player.getSkills().getMaximumLifePoints() + hitpointsModification);
                ...
                case WINE:
                    ...
                    for (int i = 0; i < drink.getSkills().length; i++) {
                        ...
                        if (skill == Skills.ATTACK) {
                            ...
                            player.getSkills().increaseLevelToMaximum(Skills.CONSTITUTION, 11);
                        }
                    }
                    break;
                case OVERLOAD:
                	//Note: the 2 messages below aren't like in real rs, just quickly made something up
                	if (player.isInWilderness()) {
                		player.sendMessage("You can't drink an overload in the wilderness.");
                		return false;
                	} else if (player.hasTick("overloadTick")) {
                		player.sendMessage("You haven't finished your previous overload, don't drink a new one!");
                		return false;
                	} else if (player.getHitPoints() <= 500) {
                		//player.sendMessage("It wouldn't be a good idea to drink an overload potion with your health.");
                        ...
                        player.submitTick("overloadRestoreTick", new Tick(2) {
                            ...
                            public void execute() {
                                ...
                                if (count <= 20 && !player.isDead() && !player.isInWilderness()) {
                ...
                case RESTORE_SPECIAL:
                    if (!player.isInWilderness() && player.getAttribute("specRestore", -1) < World.getTicks()) {
