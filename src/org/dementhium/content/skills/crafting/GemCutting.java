...
public class GemCutting {
	...
	public enum Gem {
		OPAL(1625, 1609, 2.0, 1, CLEAR_GEM_ANIMATION),
		JADE(1627, 1611, 5.0, 13, CLEAR_GEM_ANIMATION),
		RED_TOPAZ(1629, 1613, 6.5, 16, RED_GEM_ANIMATIION),
		SAPPHIRE(1623, 1607, 7.0, 20, BLUE_GEM_ANIMATION),
		EMERALD(1621, 1605, 8.0, 27, GREEN_GEM_ANIMATION),
		RUBY(1619, 1603, 9.0, 34, RED_GEM_ANIMATIION),
		DIAMOND(1617, 1601, 14.0, 43, CLEAR_GEM_ANIMATION),
		DRAGONSTONE(1631, 1615, 24.44, 55, Animation.create(885)),
		ONYX(6571, 6573, 26.5, 67, Animation.create(2717));
