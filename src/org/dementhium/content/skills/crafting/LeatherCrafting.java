...
public class LeatherCrafting {
	...
	public enum LeatherProduction {
		LEATHER_GLOVES(1059, 9.75, 1),
		LEATHER_BOOTS(1061, 10.25, 7),
		LEATHER_COWL(1167, 12.5, 9),
		LEATHER_VAMBRACES(1063, 14.0, 11),
		LEATHER_BODY(1129, 16.0, 14),
		LEATHER_CHAPS(1095, 17.0, 18),
		COIF(1169, 27.0, 38),
		GREEN_D_HIDE_VAMB(1065, 32, 57), 
		GREEN_D_HIDE_CHAPS(1099, 40, 60), 
		GREEN_D_HIDE_BODY(1135, 50, 63), 
		BLUE_D_HIDE_VAMB(2487, 40, 66), 
		BLUE_D_HIDE_CHAPS(2493, 60, 68), 
		BLUE_D_HIDE_BODY(2499, 68, 71), 
		RED_D_HIDE_VAMB(2489, 73, 73), 
		RED_D_HIDE_CHAPS(2495, 77, 75), 
		RED_D_HIDE_BODY(2501, 79, 77), 
		BLACK_D_HIDE_VAMB(2491, 80, 79), 
		BLACK_D_HIDE_CHAPS(2497, 84, 82), 
		BLACK_D_HIDE_BODY(2503, 89, 84);
