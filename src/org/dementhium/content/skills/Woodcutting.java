...
public final class Woodcutting extends HarvestAction {
    ...
    public static enum Tree implements HarvestObject {
        ...
        NORMAL(1511, 1, 5, 5, 1, new int[]{1276, 1277, 1278, 1279, 1280, 1282,
        ...
        WILLOW(1519, 30, 8.0, 30, 4, new int[]{1308, 5551, 5552, 5553}),
        OAK(1521, 15, 13.0, 15, 2, new int[]{1281, 3037}),
        MAGIC(1513, 75, 160, 120, 9, new int[]{1306}),
        MAPLE(1517, 45, 30, 60, 5, new int[]{1307, 4674}),
        MAHOGANY(6332, 50, 125, 80, 4, new int[]{9034}),
        TEAK(6333, 35, 85, 100, 4, new int[]{9036}),
        ACHEY(2862, 1, 25, 80, 4, new int[]{2023}),
        YEW(1515, 60, 100, 160, 7, new int[]{1309}),
        DRAMEN(771, 36, 50, 22, 4, new int[]{1292});
