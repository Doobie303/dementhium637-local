...
public class Mining extends HarvestAction {
	...
	DRAGON(15259, 61, Animation.create(10007)),
        ...
        IRON(1267, 1, Animation.create(10002)),
    ...
    public static enum Rock implements HarvestObject {
        ...
        COAL(453, 30, 90, 10, new int[]{5770, 5771, 5772, 11930, 11931, 11932, 14850, 14851, 14852, 31068, 31069, 31070, 32426, 32427, 32428}),
        ...
        RUNE(451, 85, 182, 30, new int[]{14859, 14860, 14861}),
        ESSENCE(7936 << 16 | 7936, 1, 5, -1, new int[] {2491}),
