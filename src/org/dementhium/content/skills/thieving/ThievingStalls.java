...
public enum ThievingStalls {
	 ...
	 */
	//ThievingStalls(int[] objectIds, int[] replaceIds, int thievingLevel, double experience, int restoreDelay, Item...items) {
			//Note that replaceId is the the way the stall should look after it's been robbed, for stalls it's often 34381
	//6984 = replaceId for blacksmall stalls
	VEGETABLE_STALL(new int[] { 4706 }, new int[] { 634 }, 2, 3.02, 3, new Item(1957), new Item(1965), new Item(1942), new Item(1982), new Item(1550)),
	BAKER_STALL(new int[] { 34384 }, new int[] { 34381 }, 5, 5.34, 4, new Item(1891), new Item(1901), new Item(2309)),
	CRAFTING_STALL(new int[] { 4874, 6166 }, new int[] { 4874 }, 5, 6.10, 12, new Item(1755), new Item(1592), new Item(1597)),
	MONKEY_FOOD_STALL(new int[] { }, new int[] { }, 5, 7.0, 12, new Item(1963)),
	MONKEY_GENERAL_STORE(new int[] { }, new int[] { }, 5, 8.0, 12, new Item(1931), new Item(2347), new Item(590)),
	TEA_STALL(new int[] { 635 }, new int[] { 634 }, 5, 9.0, 12, new Item(712)),
	SILK_STALL(new int[] { 34383 }, new int[] { 34381 }, 20, 11.0, 13, new Item(950)),
	WINE_STALL(new int[] { }, new int[] { }, 22, 12.0, 27, new Item(1937), new Item(1993), new Item(1987), new Item(1935), new Item(7919)),
	SEED_STALL(new int[] { 7053 }, new int[] { 634 }, 27, 10.0, 18, new Item(5096), new Item(5097), new Item(5098), new Item(5099), new Item(5100), new Item(5101),
    ...
    FUR_STALL(new int[] { 34387 }, new int[] { 34381 }, 35, 13.23, 25, new Item(958), new Item(6814)),
	FISH_STALL(new int[] { 4277, 4705, 4707 }, new int[] { 634 }, 42, 15.24, 27, new Item(331), new Item(359), new Item(377)),
	CROSSBOW_STALL(new int[] { 17031 }, new int[] { 17031 }, 49, 17.35, 18, new Item(877, 3), new Item(9420), new Item(9440)),
	SILVER_STALL(new int[] { 34382}, new int[] { 34381 }, 50, 18.0, 50, new Item(442)),
	//TODO: Fuck this one for a while.. CUSTOMS_EVIDENCE_FILES(new int[] { }, new int[] { }, 63, 75, 60),
	SPICE_STALL(new int[] { 34386 }, new int[] { 34381 }, 65, 5.0, 133, new Item(2007)),
	MAGIC_STALL(new int[] {4877}, new int[] {4877}, 75, 8.0, 1, new Item(7650)),
	SCIMITAR_STALL(new int[] {4878}, new int[] {4878}, 60, 13.0, 1, new Item(1247)),
	GEM_STALL(new int[] { 34385 }, new int[] { 34381 }, 75, 25.0, 300, new Item(1617), new Item(1619), new Item(1621), new Item(1623)),
	
	CUSTOM_GEM_STALL(new int[] { 6162 }, new int[] { 6162 }, 65, 11.0, 40, new Item(995, 900)),
	CUSTOM_MARKET_STALL(new int[] { 14011 }, new int[] { 634 }, 80, 19.0, 50, new Item(995, 1200)),
	CUSTOM_SILVER_STALL(new int[] { 6164 }, new int[] { 6164 }, 92, 18.0, 70, new Item(995, 1000)), //this one is faster than the above
	;
