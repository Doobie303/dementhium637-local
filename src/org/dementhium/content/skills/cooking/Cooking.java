...
public class Cooking extends ProduceAction {
    ...
    public enum CookingItem {
        ...
        RAW_SHRIMPS(1, new Item[]{new Item(317)}, new Item(323), 4,
                new Item(315), true),

        RAW_SARDINE(1, new Item[]{new Item(327)}, new Item(323), 7,
                new Item(325), true),

        RAW_ANCHOVIES(1, new Item[]{new Item(321)}, new Item(323), 4,
                new Item(319), true),

        POISON_KARAMBWAN(1, new Item[]{new Item(3142)}, new Item(3148), 3,
                new Item(3151), true),

        RAW_HERRING(5, new Item[]{new Item(345)}, new Item(357), 3,
                new Item(347), true),

        RAW_MACKEREL(10, new Item[]{new Item(353)}, new Item(357), 2,
                new Item(355), true),

        RAW_TROUT(15, new Item[]{new Item(335)}, new Item(343), 2,
                new Item(333), true),

        RAW_COD(18, new Item[]{new Item(341)}, new Item(343), 3, new Item(
                339), true),

        RAW_PIKE(20, new Item[]{new Item(349)}, new Item(343), 4, new Item(
                351), true),

        RAW_SALMON(25, new Item[]{new Item(331)}, new Item(343), 5,
                new Item(329), true),

        RAW_SLIMY_EEL(28, new Item[]{new Item(3379)}, new Item(3383), 6,
                new Item(3381), true),

        RAW_TUNA(30, new Item[]{new Item(359)}, new Item(367), 8,
                new Item(361), true),

        RAW_RAINBOW_FISH(35, new Item[]{new Item(10138)}, new Item(10140),
                10, new Item(10136), true),

        RAW_CAVE_EEL(38, new Item[]{new Item(5001)}, new Item(5006), 15,
                new Item(5003), true),

        RAW_LOBSTER(40, new Item[]{new Item(377)}, new Item(381), 20,
                new Item(379), true),

        RAW_BASS(43, new Item[]{new Item(363)}, new Item(367), 32,
                new Item(365), true),

        RAW_SWORDFISH(45, new Item[]{new Item(371)}, new Item(375), 36,
                new Item(373), true),

        RAW_LAVA_EEL(53, new Item[]{new Item(2148)}, new Item(-1), 40,
                new Item(2149), true),

        RAW_MONKFISH(62, new Item[]{new Item(7944)}, new Item(7948), 50,
                new Item(7946), true),

        RAW_SHARK(80, new Item[]{new Item(383)}, new Item(387), 70,
                new Item(385), true),

        RAW_SEA_TURTLE(82, new Item[]{new Item(395)}, new Item(399), 99,
                new Item(397), true),

        RAW_CAVEFISH(88, new Item[]{new Item(15264)}, new Item(15268), 214,
                new Item(15266), true),

        RAW_MANTA_RAY(91, new Item[]{new Item(389)}, new Item(393), 110,
                new Item(391), true),

        RAW_ROCKTAIL(92, new Item[]{new Item(15270)}, new Item(15274), 90,
                new Item(15272), true),
