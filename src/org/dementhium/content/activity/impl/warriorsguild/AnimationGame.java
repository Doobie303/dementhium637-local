...
public class AnimationGame extends WarriorsGuildMinigame {
    ...
    public static final Location[] LOCATIONS = new Location[]{Location.locate(2851, 3533, 0), Location.locate(2857, 3533, 0)};
    ...
    public boolean commenceSession() {
        ...
        player.forceMovement(BACKWARDS_WALK, location.getX(), location.getY() + 4, 0, 45, 4, 1, true);
         player.submitTick("walkTick", new Tick(3) {
            @Override
            public void execute() {
                stop();
                player.submitTick("spawnTick", new Tick(2) {
                    ...
                    public void execute() {
                        ...
                        animArmour.getMask().setInteractingEntity(player, false);
