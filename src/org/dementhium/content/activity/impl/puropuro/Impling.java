...
public enum Impling {
	 ...
	 */
	BABY_IMPLING(1028, 1, 2.0, 11238, 7),

	/**
	 * Represents a young impling.
	 */
	YOUNG_IMPLING(1029, 10, 9.0, 11240, 7),
	
	/**
	 * Represents a gourmet impling.
	 */
	GOURMET_IMPLING(1030, 28, 14.0, 11242, 7),
	
	/**
	 * Represents an earth impling.
	 */
	EARTH_IMPLING(1031, 36, 20.0, 11244, 7),
	
	/**
	 * Represents an essence impling.
	 */
	ESSENCE_IMPLING(1032, 42, 25.0, 11246, 7),
	
	/**
	 * Represents an eclectic impling.
	 */
	ECLECTIC_IMPLING(1033, 50, 29.0, 11248, 7),
	 ...
	 */
	NATURE_IMPLING(1034, 58, 39.0, 11250, 7),
	
	/**
	 * Represents a magpie impling.
	 */
	MAGPIE_IMPLING(1035, 65, 55.0, 11252, 500),
	
	/**
	 * Represents a ninja impling.
	 */
	NINJA_IMPLING(6053, 74, 65.0, 11254, 2000),
	
	/**
	 * Represents a dragon impling.
	 */
	DRAGON_IMPLING(6054, 83, 80.0, 11256, 3000),
	
	/**
	 * Represents a kingly impling.
	 */
	KINGLY_IMPLING(7903, 91, 97.0, 15517, 5000);
