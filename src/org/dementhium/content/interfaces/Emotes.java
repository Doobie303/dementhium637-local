...
public class Emotes {
	 ...
	 * Loyalty emotes:
 	Facepalm: anim 2254
	ROFL: anim 2347
	Hula Hoop: anim 12928
	Ghost: anim 12932, gfx 1762
	Cat Fight: 2252
	Head in Sand: anim 12926, gfx 1761
	Levitate - Animation 2327
	
	1766 - grim reaper emote (Deathcon one)
	2196 - tornado
	2195 - good emote (divine power)
	2197 - evil emote (opposite of divine power, can't remember name)
	2742 - lightning emote (invoke storm i think its called)
	 * 
	 */
	...
	public static void handleButton(final Player player, final int buttonId, int buttonId2, int buttonId3) {
		...
		if(player.getSettings().isResting()){
			player.sendMessage("Emotes aren't very restful!");
			return;
		}
		if (buttonId == 46) {
