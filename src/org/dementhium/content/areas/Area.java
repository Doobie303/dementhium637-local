...
public abstract class Area {
    ...
    public void teleTo(Player player) {
    	if (centerX != 0 && centerY != 0
    			&& centerX != -1 && centerY != -1)
    		player.teleport(centerX, centerY, height, true);
    	else
    		player.teleport(swX + ((nwX - swX) / 2), swY + ((nwY - swY) / 2), height, true);
    }
    
    public void teleToWithAnimAndGfx(Player player) {
    	if (centerX != 0 && centerY != 0
    			&& centerX != -1 && centerY != -1)
    		player.teleportWithAnimAndGfx(centerX, centerY, height, false, true);
    	else
    		player.teleportWithAnimAndGfx(swX + ((nwX - swX) / 2), swY + ((nwY - swY) / 2), height, false, true);
    }
