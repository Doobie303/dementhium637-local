...
public class NPCDefinition {
     ...
     */
    private short attackAnimation = 422;

    /**
     * The NPCs defence animation.
     */
    private short defenceAnimation = 404;

    /**
     * The NPCs death animation.
     */
    private short deathAnimation = 9055;
    ...
    public int getHitpoints() {
    	if (id == 7727) //monks, didn't feel like making a whole definition
    		return 150;
        return lifepoints;
    }
