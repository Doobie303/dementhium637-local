            ...
            switch (objectId) {
                ...
                case 26341:
                    if (player.getSettings().hasGodEntranceRope()) {
                        player.teleport(GOD_DUNGEON, false);
                    }
                    return true;
                case 26293:
                    player.teleport(GOD_DUNGEON_ENTRANCE, false);
                    return true;
                ...
                case 26439:
                    ...
                    World.getWorld().submit(new Tick(3) {
                        ...
                        @Override
                        public void execute() {
                            player.teleport(player.getLocation().getX(), player.getLocation().getY() < 5338 ? 5337 : 5331, 2, false);
