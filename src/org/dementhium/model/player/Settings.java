...
public class Settings {
    ...
    private boolean dungSpellBook = false;
    private int privateTextColor = 0;
    private int clanChatTextColor = 4;
    
    private int privateChatSetting = 0;
    
    private boolean acceptAidOn = true;
    ...
    private boolean[] leveledUpConfig = new boolean[Skills.SKILL_COUNT];
    private String[] playerOptions = new String[8]; //was 6
    ...
    public void setDungeoneeringSpellBook(boolean dungBook) {
        this.dungSpellBook = dungBook;
    }
    ...
    public void setPrivateChatSetting(int setting) {
        privateChatSetting = setting;
    }
    ...
    public void setClanChatTextColor(int clanTextColor) {
        this.clanChatTextColor = clanTextColor;
    }

    public int getClanChatTextColor() {
        return clanChatTextColor;
    }
    
    public boolean getAcceptAidOn() {
        return acceptAidOn;
    }

    public void setAcceptAidOn(boolean setting) {
        acceptAidOn = setting;
    }
    ...
    public boolean[] getLeveledUpConfig() {
        return leveledUpConfig;
    }
