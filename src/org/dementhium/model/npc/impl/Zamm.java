...
import org.dementhium.model.combat.impl.npc.SaradominAction;
import org.dementhium.model.combat.impl.npc.ZammAction;
 ...
 *
 */
public class Zamm extends NPC {

	/**
	 * The combat action to use.
	 */
	private final CombatAction COMBAT_ACTION = new ZammAction();
